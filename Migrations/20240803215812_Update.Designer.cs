...
namespace TankWiki.Migrations
{
    ...
    [Migration("20240803215812_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GunTurret", b =>
                {
                    b.Property<int>("GunsGunId")
                        .HasColumnType("int");

                    b.Property<int>("TurretsTurretId")
                        .HasColumnType("int");

                    b.HasKey("GunsGunId", "TurretsTurretId");

                    b.HasIndex("TurretsTurretId");
            ...
            modelBuilder.Entity("GunTurret", b =>
                {
                    b.HasOne("TankWiki.Models.ModelTank.Gun", null)
                        .WithMany()
                        .HasForeignKey("GunsGunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TankWiki.Models.ModelTank.Turret", null)
                        .WithMany()
                        .HasForeignKey("TurretsTurretId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
