...
namespace TankWiki.Migrations
{
    ...
    [Migration("20240804212417_AddListTankToNationAndTankType")]
    partial class AddListTankToNationAndTankType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TankWiki.Models.TypeMachine", b =>
                {
            ...
            modelBuilder.Entity("TankWiki.Models.ModelTank.Armor", b =>
                {
                    b.HasOne("TankWiki.Models.ModelTank.Tank", "Tank")
                        .WithOne("Armor")
                        .HasForeignKey("TankWiki.Models.ModelTank.Armor", "TankId");
            ...
            modelBuilder.Entity("TankWiki.Models.ModelTank.Tank", b =>
                {
                    ...
                    b.HasOne("TankWiki.Models.TypeMachine", "TypeMachine")
                        .WithMany("Tanks")
